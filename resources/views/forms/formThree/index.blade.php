                ...
                <div class="row">
                    <div class="col-md-12 col-md-offset-1 animate-box">
                        ...
                        <form action="#">
                            ...
                            <div class="row form-group">
                                <div class="col-md-12">
                                    <label for="fname">Residental Address: </label>
                            ...
                            <div class="row form-group">
                                <div class="col-md-12">
                                    ...
                                    <input type="text" class="form-control mb" placeholder="Your Father name"
                                           name="father_name">
                                </div>
                                <div class="col-md-12">
                                    <label for="occupation">Occupation: </label>
                                    <input type="text" class="form-control mb" placeholder="Your Father occupation"
                                           name="occupation">
                                </div>
                            </div>
                            ...
                            <div class="row form-group">
                                <div class="col-md-12">
                                    ...
                                    <input type="text" class="form-control mb" placeholder="Your Contact"
                                           name="contact">
                                </div>
                                <div class="col-md-12">
                                    <label for="watsapp">Whatsapp No: </label>
                                    <input type="text" class="form-control mb" placeholder="Your watsapp contact"
                                           name="watsapp">
                                </div>
                            </div>
                            ...
                            <div class="borderdiv">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <input type="checkbox" class="mr-2" id="playground" name="playground" value="playground">
                                    <label for="email">Maths</label>
                                    <input type="checkbox" class="mr-2" id="nursery" name="nursery" value="nursery">
                            ...
                            <div class="row form-group">
                                <div class="col-md-12">
                                    <label for="contact">Passport Size photo: </label>
                                    <input type="file" class="form-control mb"
                                           name="image">
                                </div>
                            </div>
